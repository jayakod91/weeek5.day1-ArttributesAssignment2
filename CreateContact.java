...
public class CreateContact {
		...
		public void main() throws InterruptedException  
		{
			...
			driver.findElement(By.id("firstNameField")).sendKeys("vasu");
			driver.findElement(By.id("lastNameField")).sendKeys("D");
			driver.findElement(By.id("createContactForm_firstNameLocal")).sendKeys("nethik");
